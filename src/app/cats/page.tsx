  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-6 bg-center md:grid-cols-2 md:gap-8 xl:grid-cols-2 2xl:gap-10">
        <button
          onClick={() => handleOptionChange("cards")}
          className={`card ${selectedOption === "cards" ? "selected" : ""}`}
        >
        ...
        <button
          onClick={() => handleOptionChange("cats")}
          className={`card ${selectedOption === "cats" ? "selected" : ""}`}
        >
          <div className="card-title">cats</div>
          <div>
            <svg
              className="fill-primary dark:fill-white"
              width="20"
